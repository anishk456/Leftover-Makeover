...
def ingredient_parser(ingreds):
    ...
    '''
    measures = ['teaspoon', 't', 'tsp','tsp.', 'tablespoon', 'T', 'tbl', 'tb', 'tbsp', 'tblsp' 'fluid ounce', 'fl oz', 'gill', 'cup', 'c', 'pint', 'p', 'pt', 'fl pt', 'quart', 'q', 'qt', 'fl qt', 'gallon', 'g', 'gal', 'ml', 'milliliter', 'millilitre', 'cc', 'mL', 'l', 'liter', 'litre', 'L', 'dl', 'deciliter', 'decilitre', 'dL', 'bulb', 'level', 'heaped', 'rounded', 'whole', 'pinch', 'medium', 'slice', 'pound', 'lb', '#', 'ounce', 'oz', 'mg', 'milligram', 'milligramme', 'g', 'gram', 'gramme', 'kg', 'kilogram', 'kilogramme', 'x', 'of', 'mm', 'millimetre', 'millimeter', 'cm', 'centimeter', 'centimetre', 'm', 'meter', 'metre', 'inch', 'in', 'milli', 'centi', 'deci', 'hecto', 'kilo']
...
if __name__ == "__main__":
    df = pd.read_csv('/Users/anish/Documents/ML/honestcooking_all_recipes.csv')
    df = df[df.astype(str)['ingredients'] != '[]']

    df.to_csv('/Users/anish/Documents/ML/honestcooking_all_recipes_cleaned.csv', index=False)

    recipe_df = pd.read_csv('/Users/anish/Documents/ML/honestcooking_all_recipes_cleaned.csv')
    ...
    df.to_csv('/Users/anish/Documents/ML/honestcooking_all_recipes_parsed.csv', index=False)
